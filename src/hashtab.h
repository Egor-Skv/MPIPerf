 ...
 * got from https://github.com/skeeto/hashtab
 */
...
#define memht_search(h, k)    ht_search(h, k, 4)
#define memht_insert(h, k, v) ht_insert(h, k, 4, v, 4)
#define memht_remove(h, k)    ht_remove(h, k, 4);
